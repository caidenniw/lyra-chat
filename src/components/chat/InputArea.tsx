...
export function InputArea({ onSend, isStreaming = false, selectedModel, onModelChange }: InputAreaProps) {
  ...
  return (
    <div className="relative bg-bg md:bg-transparent pb-3 md:pb-8 border-t md:border-t-0 border-border/30 md:border-0">
      <div className="max-w-3xl mx-auto px-3 md:px-8 pt-2 md:pt-2 pb-0.5 md:pb-2">
        {/* Streaming indicator */}
        {isStreaming && (
